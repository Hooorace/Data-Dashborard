...
def cht_priceShare(data_source):
    ...
    colors = {
        ...
        '24-28': 'rgba(229, 1, 18, 0.7)',
        '28-30': 'rgba(254, 88, 100, 0.7)',
        '30-32': 'rgba(255, 143, 152, 0.7)',
        '32-35': 'rgba(112, 112, 112, 0.7)',
        '35-40': 'rgba(172, 168, 168, 0.7)',
        '40-50': 'rgba(255, 216, 91, 0.7)',
        '50-70': 'rgba(255, 192, 0, 0.7)',
        '70-100': 'rgba(237, 125, 50, 0.7)',
        '>=100': 'rgba(197, 90, 17, 0.7)'
    }
